...
<html>
  ...
  <body>
  	...
  	<button type="button" class="btn btn-link" id="return">
		<a href='<s:url action="admin_loadAllAdmin.do" namespace="/admin" />'>返回上一级</a>
	</button>
	<h1>修改管理员信息</h1>
	...
	<s:form action="admin_update.do" namespace="/admin" method="post" id="form" class="form-horizontal">
		<div class="form-group">
			<label for="userName" class="col-sm-2 col-sm-offset-3 control-label">管理员ID：</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<s:textfield name="user.realName" id="realName" class="form-control" placeholder="真实姓名" required="required"></s:textfield>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="identify" class="col-sm-2 col-sm-offset-3 control-label">身份：</label>
			<div class="col-sm-3" style="margin-top:5px">
				<s:radio name="user.identify" list="#{\"1\":'普通管理员',\"0\":'超级管理员'}"></s:radio>
			</div>
		</div>
		<div class="form-group">
			<label for="birthday" class="col-sm-2 col-sm-offset-3 control-label">出生日期：</label>
			<div class="col-sm-3">
				<s:textfield name="user.birthday" id="birthday" placeholder="出生日期" required="required" class="form-control">
					<s:param name="value">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<s:textfield name="user.email" id="email" class="form-control" placeholder="电子邮箱" required="required"></s:textfield>
			</div>
		</div>
		<div class="form-group">
			<label for="phone" class="col-sm-2 col-sm-offset-3 control-label">电话号码：</label>
			<div class="col-sm-3">
				<s:textfield name="user.phone" id="phone" class="form-control" placeholder="电话号码" required="required"></s:textfield>
			</div>
		</div>
		<div class="form-group">
			<label for="postCode" class="col-sm-2 col-sm-offset-3 control-label">邮政编码：</label>
			<div class="col-sm-3">
				<s:textfield name="user.postCode" id="postCode" class="form-control" placeholder="邮政编码" required="required"></s:textfield>
			</div>
		</div>
		<div class="form-group">
			<label for="postCode" class="col-sm-2 col-sm-offset-3 control-label">地址：</label>
			<div class="col-sm-3">
				<s:textarea id="address" name="user.address" class="form-control" required="required" rows="3"></s:textarea>
			</div>
		</div>
		<div class="form-group">
