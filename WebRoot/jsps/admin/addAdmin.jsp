...
<html>
  ...
  <body>
  	...
  	<button type="button" class="btn btn-link" id="return">
		<a href='<s:url action="/admin_loadAllAdmin" namespace="/admin" />'>返回上一级</a>
	</button>
	<h1>添加商品类别</h1>
	<div class="errorMessage">
	
	</div>
	<s:form action="admin_add.do" namespace="/admin" method="post" id="form" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-3" style="margin-top:5px">
				<s:radio name="identify" list="#{\"1\":'普通管理员',\"0\":'超级管理员'}" value="1"></s:radio>
			</div>
		</div>
		<div class="form-group">
