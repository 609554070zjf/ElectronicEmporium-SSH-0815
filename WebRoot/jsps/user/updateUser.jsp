...
<html>
  ...
  <body>
	...
	<s:form action="user_updateUser.do" namespace="/user" method="post" id="form" class="form-horizontal">
		<div class="form-group">
			<label for="userName" class="col-sm-2 col-sm-offset-3 control-label">用户ID：</label>
			<div class="col-sm-3">
		...
		<s:hidden name="user.identify" value="2"></s:hidden>
		<div class="form-group">
